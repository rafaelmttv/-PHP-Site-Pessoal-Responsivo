<section class="banner-container">
	...
	<section class="descricao-autor">
		<div class="center">
			...
			<div class="w50 left">
				<img class="right" src="<?php echo INCLUDE_PATH; ?>images/e.png">
			</div>
			<div class="clear"></div>
		</div>	
	</section>
	...
	<section class="especialidades">
		<div class="center" id="especialidades">
			<h2 class="title">Especialidades</h2>
			<div class="w33 left box-especialidade">
				<h3><i class="fa-brands fa-php" aria-hidden="true"></i></h3>
				<h4>PHP</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</p>
			</div><!--box-especialidade-->

			<div class="w33 left box-especialidade">
				<h3><i class="fa-brands fa-laravel"></i></i></h3>
				<h4>Laravel</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</p>
			</div><!--box-especialidade-->
			...
			<div class="w33 left box-especialidade">
			<h3><i class="fa-brands fa-html5" aria-hidden="true"></i></h3>
				<h4>HTML 5</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod</p>
			</div><!--box-especialidade-->

			<div class="w33 left box-especialidade">
				<h3><i class="fa-solid fa-database"></i></i></h3>
